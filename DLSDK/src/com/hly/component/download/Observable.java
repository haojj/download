...
public abstract class Observable {
    ...
    public void detach(Observer observer) {
    	Log.d("raw", "detach...:"+mObservers.size());
        if (mIterator != null) {
            mIterator.remove();
            Log.d("raw", "mIterator remove...:"+mObservers.size());
        } else {
            mObservers.remove(observer);
            Log.d("raw", "mObservers remove...:"+mObservers.size());
        }
    }
    ...
    public void notifyObservers() {
    	Log.d("raw", "notifyObservers...:"+mObservers.size());
    ...
    public void notifyProgress(int progressBytes) {
        ...
        try {
            while (mIterator.hasNext()) {
                mIterator.next().progress(this, progressBytes);
            }
        } finally {
            mIterator = null;
        }
